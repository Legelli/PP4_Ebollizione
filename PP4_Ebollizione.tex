...
I dati raccolti sono riportati nella tabella \ref{tab:misure}, nel grafico \ref{fig:grafico} sono invece riportati i valori del logaritmo $\log (P/P_0)$ al variare della quantità $1/T$, insieme al fit lineare dei dati.
